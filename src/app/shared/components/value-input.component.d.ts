...
export declare class ValueInputComponent implements OnInit, OnDestroy, OnChanges, ControlValueAccessor {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<ValueInputComponent, "tb-value-input", never, { "disabled": "disabled"; "requiredText": "requiredText"; "valueType": "valueType"; "trueLabel": "trueLabel"; "falseLabel": "falseLabel"; "layout": "layout"; }, {}, never, never, false, never>;
}
export {};
