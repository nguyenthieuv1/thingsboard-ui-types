...
export declare class ValueInputComponent implements OnInit, OnDestroy, OnChanges, ControlValueAccessor {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<ValueInputComponent, "tb-value-input", never, { "disabled": { "alias": "disabled"; "required": false; }; "requiredText": { "alias": "requiredText"; "required": false; }; "valueType": { "alias": "valueType"; "required": false; }; "allowedValueTypes": { "alias": "allowedValueTypes"; "required": false; }; "trueLabel": { "alias": "trueLabel"; "required": false; }; "falseLabel": { "alias": "falseLabel"; "required": false; }; "shortBooleanField": { "alias": "shortBooleanField"; "required": false; }; "required": { "alias": "required"; "required": false; }; "hideJsonEdit": { "alias": "hideJsonEdit"; "required": false; }; "layout": { "alias": "layout"; "required": false; }; }, {}, never, never, false, never>;
}
export {};
