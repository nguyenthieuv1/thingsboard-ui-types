...
export declare class EntitySubTypeListComponent implements ControlValueAccessor, OnInit, AfterViewInit, OnDestroy {
    ...
    constructor(broadcast: BroadcastService, translate: TranslateService, assetService: AssetService, deviceService: DeviceService, edgeService: EdgeService, entityViewService: EntityViewService, alarmService: AlarmService, utils: UtilsService, fb: FormBuilder);
