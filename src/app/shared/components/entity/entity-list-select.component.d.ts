...
export declare class EntityListSelectComponent implements ControlValueAccessor, OnInit, AfterViewInit {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<EntityListSelectComponent, "tb-entity-list-select", never, { "allowedEntityTypes": "allowedEntityTypes"; "useAliasEntityTypes": "useAliasEntityTypes"; "required": "required"; "disabled": "disabled"; }, {}, never, never, false>;
}
export {};
