...
export declare class ManageDashboardCustomersDialogComponent extends DialogComponent<ManageDashboardCustomersDialogComponent, boolean> implements OnInit, ErrorStateMatcher {
    ...
    constructor(store: Store<AppState>, router: Router, data: ManageDashboardCustomersDialogData, dashboardService: DashboardService, errorStateMatcher: ErrorStateMatcher, dialogRef: MatDialogRef<ManageDashboardCustomersDialogComponent, boolean>, fb: UntypedFormBuilder);
    ngOnInit(): void;
