...
export declare class JsLibraryTableConfigResolver {
    ...
    constructor(store: Store<AppState>, resourceService: ResourceService, translate: TranslateService, dialog: MatDialog, dialogService: DialogService, router: Router, datePipe: DatePipe);
