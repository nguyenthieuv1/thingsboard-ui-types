...
export declare class DeviceCredentialsDialogComponent extends DialogComponent<DeviceCredentialsDialogComponent, DeviceCredentials> implements OnInit, ErrorStateMatcher {
    ...
    private submitted;
    constructor(store: Store<AppState>, router: Router, data: DeviceCredentialsDialogData, deviceService: DeviceService, deviceProfileService: DeviceProfileService, errorStateMatcher: ErrorStateMatcher, dialogRef: MatDialogRef<DeviceCredentialsDialogComponent, DeviceCredentials>, fb: UntypedFormBuilder);
    ngOnInit(): void;
