...
import { AlarmAssignee, AlarmDataInfo, AlarmInfo } from '@shared/models/alarm.models';
...
export declare class AlarmsTableWidgetComponent extends PageComponent implements OnInit, OnDestroy, AfterViewInit {
    ...
    cellContent(alarm: AlarmDataInfo, key: EntityColumn, row: number): Observable<SafeHtml>;
