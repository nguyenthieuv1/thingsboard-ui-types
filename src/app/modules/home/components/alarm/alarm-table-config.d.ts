...
import { AlarmInfo, AlarmSearchStatus, AlarmsMode } from '@app/shared/models/alarm.models';
...
export declare class AlarmTableConfig extends EntityTableConfig<AlarmInfo, TimePageLink> {
    ...
    constructor(alarmService: AlarmService, dialogService: DialogService, translate: TranslateService, datePipe: DatePipe, dialog: MatDialog, alarmsMode: AlarmsMode, entityId: EntityId, defaultSearchStatus: AlarmSearchStatus, store: Store<AppState>, viewContainerRef: ViewContainerRef, overlay: Overlay, cd: ChangeDetectorRef, utilsService: UtilsService, pageMode?: boolean);
